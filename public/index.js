...
const editProfilePopup = new PopupWithForm("#popup-edit-profile", async (formData) => {
...
const newCardPopup = new PopupWithForm("#popup-add-card", async (formData) => {
...
const editAvatarPopup = new PopupWithForm("#popup-edit-avatar", async (formData) => {
